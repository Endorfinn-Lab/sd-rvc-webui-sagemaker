...
civitai_api_key = "e5c4fbaa29031f1b61ccc6c352ce352c" # Put your Civitai API key here
        ...
        for url in urls:
            ...
            if url != "":
                ...
                if url.startswith("fuse:"):
                    fuse(url, key, dst) # Assuming you have a fuse function defined
                elif key == "extensions":
                    clone_repo(url, cwd=dst)
                else:
                    # Add Civitai API key to headers if the URL is from Civitai
